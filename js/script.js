...
function menuPrincipal (menu){
    ...
    if (productos == 1) {
        alert("compraste teclado 100%, su valor es de $" + teclado100Precio);
    } else if (productos == 2) {
        alert("compraste teclado 75%, su valor es de $" + teclado75Precio);
    } else if (productos == 3)
        alert("compraste teclado 60%, su valor es de $" + teclado60Precio);
    else{
